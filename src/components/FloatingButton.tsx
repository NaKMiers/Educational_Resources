...
function FloatingButton({ className = '' }: ContactFloatingProps) {
  ...
  return (
    <div
      className={`fixed z-030 right-3 bottom-[80px] bg-dark-100 flex items-center rounded-xl transition-all duration-300 overflow-hidden shadow-medium-light select-none ${className}`}>
      <Link
        href='/flash-sale'
